(function () {
  ...
  var createModel = function () {
    ...
    createModel.prototype.inform = function inform(model) {
    ...
    */
    ...
    createModel.prototype.update = function update(lookupId, updateObj) {
    ...
    */
    ...
    createModel.prototype.destroy = function destroy(lookupId, objId) {
  ...
  function genModelList (node, model, tmplHandler) {
    ...
    if (!cache[model].ref) {
      if (list.hasAttribute('id') && list.id.match(re$2)) {
        cache[model].ref = list.id.replace(re$2, '$1');
      ...
      for (i = nodeAttributes.length; i--;) {
        ...
        if (/^k-/.test(name)) {
          ...
          if (c !== undefined && typeof c === 'function') {
            ...
            if (node.hasChildNodes() && node.firstChild.nodeType !== DOCUMENT_ELEMENT_TYPE$1 && node.firstChild.nodeValue.match(modelRaw)) {
  ...
  function parseStr (stub) {
    ...
    if (el) {
      if (el.nodeType === DOCUMENT_ELEMENT_TYPE$3) {
  ...
  function _mount (instance) {
    ...
    if (typeof instance === 'string') {
      ...
      if (instance['nodeType'] === DOCUMENT_ELEMENT_TYPE$4) {
  ...
  var App$1 = function (_Keet) {
    ...
    function App() {
      ...
      return _ret = (_temp = (_this = possibleConstructorReturn(this, _Keet.call.apply(_Keet, [this].concat(args))), _this), _this.el = 'todo-list', _this.todoModel = todoModel, _temp), possibleConstructorReturn(_this, _ret);
    }
    ...
    App.prototype.evtTodo = function evtTodo(target) {
    ...
    App.prototype.toggleTodo = function toggleTodo(id, completed) {
      this.todoModel.update('id', { id: id, completed: completed });
    };

    App.prototype.todoDestroy = function todoDestroy(id) {
  ...
  var App$2 = function (_Keet) {
    ...
    App.prototype.create = function create(evt) {
      ...
      if (title) {
        this.todoApp.addTodo({ id: genId$1(), title: title, completed: false });
        evt.target.value = '';
      }
    };
